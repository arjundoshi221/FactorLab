"""Charles Schwab authenticated HTTP session factory."""
...
class SchwabSession(requests.Session):
    """Session that adopts a refreshed tmpfs access token before each request."""
...
def get_session(token: str | None = None) -> SchwabSession:

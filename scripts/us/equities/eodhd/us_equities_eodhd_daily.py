...
Usage:
    python scripts/us/equities/eodhd/us_equities_eodhd_daily.py                  # demo: 4 free tickers
    python scripts/us/equities/eodhd/us_equities_eodhd_daily.py --symbols AAPL.US MSFT.US
    python scripts/us/equities/eodhd/us_equities_eodhd_daily.py --from-date 2025-01-01
    python scripts/us/equities/eodhd/us_equities_eodhd_daily.py --db              # also write to Postgres
"""
...
# Path layout: scripts/us/equities/eodhd/<file>.py
#   parents[0]=eodhd, [1]=equities, [2]=us, [3]=scripts, [4]=repo root
...
log = logging.getLogger("us_equities_eodhd_daily")

DEMO_SYMBOLS = ["AAPL.US", "TSLA.US", "AMZN.US", "VTI.US"]
DATA_DIR = raw_dir("eodhd")
